...
sink("/root/taka/RNA-seq/deseq2/RNA-Seq_featureCounts_introns.log")
...
annot.ext="/root/resources/mm10_GENCODEBasiCVM18_UCSC_intron.gtf",
...
saveRDS(dat,"HSC_counts_introns.rds")
#
